...
function ProductNavbar() {
    ...
    const handleSubmit = (e) => {
        ...
        const api = `https://strapi-store-server.onrender.com/api/products?search=${search}&category=${category}&company=${company}&price=${rangeValue}`;
    ...
    return (
        <form
            ...
            className="align-element mt-10 grid relative  sm:grid-cols-2 md:grid-cols-3 rounded-md lg:grid-cols-4 p-5 gap-5 products-border"
        >
            <div>
                ...
                <input
                    ...
                    value={search}
                    className="input input-primary w-full input-sm max-w-xs dark:text-[#F0F6FF] rounded-xl p-1 px-2 my-3"
                />
            </div>
            <div>
            ...
            <div>
                <label htmlFor="price" className="dark:text-[#F0F6FF] range range-primary">Select Price </label>
                <br />
                <input
                    className="w-56 range range-primary"
                    type="range"
                    min={100}
                    max={100000}
                    value={rangeValue}
                ...
                <div className="flex items-center gap-24">
                    ...
                    <p className="text-center dark:text-[#F0F6FF] font-bold">Max : $1,000.00</p>
                </div>
            </div>
